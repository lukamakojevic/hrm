...
class TeamServiceTest {
    ...
    void create() {
        ...
        when(teamMapper.toEntity(team, employeeEntity))
                .thenReturn(teamEntity);
        when(teamRepository.saveAndFlush(teamEntity))
                .thenReturn(teamEntity);
        when(teamMapper.toDto(teamEntity))
                .thenReturn(team);
    ...
    void createWithoutTeamLead() {
        ...
        when(teamRepository.saveAndFlush(teamEntity))
                .thenReturn(teamEntity);
        when(teamMapper.toEntity(team, null))
                .thenReturn(teamEntity);
        when(teamMapper.toDto(teamEntity))
                .thenReturn(team);
    ...
    void readWithFilters() {
        ...
        when(searchRepository.findTeams(searchParams))
                .thenReturn(teamEntities);
        when(teamMapper.toDtos(teamEntities))
                .thenReturn(teams);
    ...
    void update() {
        ...
        when(employeeRepository.findById(EMPLOYEE_ID))
                .thenReturn(Optional.of(employeeEntity));
        when(teamMapper.toEntity(teamUpdate, employeeEntity))
                .thenReturn(teamEntity);
        when(teamRepository.saveAndFlush(teamEntity))
                .thenReturn(teamEntity);
        when(teamMapper.toDto(teamEntity))
                .thenReturn(teamUpdate);
    ...
    void updateWithNoTeamLead() {
        ...
        when(teamRepository.findById(TEAM_ID))
                .thenReturn(Optional.of(teamEntity()));
        when(teamMapper.toEntity(teamUpdate, null))
                .thenReturn(teamEntity);
        when(teamRepository.saveAndFlush(teamEntity))
                .thenReturn(teamEntity);
        when(teamMapper.toDto(teamEntity))
    ...
    void updateNonExistingTeam() {
        ...
        HrmException exception = assertThrows(HrmException.class, () -> teamService.update(TEAM_ID, teamUpdate));
