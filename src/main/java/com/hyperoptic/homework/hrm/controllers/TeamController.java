...
public class TeamController {
    ...
    public ResponseEntity<List<Team>> read(
            ...
            @RequestParam(required = false)
            @Parameter(description = "Search by any of listed employee names") List<String> teamLeadNames,
            @RequestParam(required = false)
            @Parameter(description = "Search by any of listed employees names") List<String> teamMemberNames) {
