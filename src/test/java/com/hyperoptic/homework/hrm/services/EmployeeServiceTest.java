...
class EmployeeServiceTest {
    ...
    void create() {
        ...
        when(employeeMapper.toEntity(employee, teamEntity))
                .thenReturn(employeeEntity);
        when(employeeRepository.saveAndFlush(employeeEntity))
                .thenReturn(employeeEntity);
        when(employeeMapper.toDto(employeeEntity))
                .thenReturn(employee);
    ...
    void createWithoutTeam() {
        ...
        when(employeeRepository.saveAndFlush(employeeEntity))
                .thenReturn(employeeEntity);
        when(employeeMapper.toEntity(employee, null))
                .thenReturn(employeeEntity);
        when(employeeMapper.toDto(employeeEntity))
                .thenReturn(employee);
    ...
    void createWithNonExistingTeam() {
        ...
        HrmException exception = assertThrows(HrmException.class, () -> employeeService.create(employee));
    ...
    void readWithFilters() {
        ...
        when(searchRepository.findEmployees(searchParams))
                .thenReturn(employeeEntities);
        when(employeeMapper.toDtos(employeeEntities))
    ...
    void readNonExistingEmployee() {
        ...
        HrmException exception = assertThrows(HrmException.class, () -> employeeService.read(EMPLOYEE_ID));
    ...
    void update() {
        ...
        when(teamRepository.findById(TEAM_ID))
                .thenReturn(Optional.of(teamEntity));
        when(employeeMapper.toEntity(employeeUpdate, teamEntity))
                .thenReturn(employeeEntity);
        when(employeeRepository.saveAndFlush(employeeEntity))
                .thenReturn(employeeEntity);
        when(employeeMapper.toDto(employeeEntity))
    ...
    void updateWithNoTeam() {
        ...
        when(employeeRepository.findById(EMPLOYEE_ID))
                .thenReturn(Optional.of(employeeEntity()));
        when(employeeMapper.toEntity(employeeUpdate, null))
                .thenReturn(employeeEntity);
        when(employeeRepository.saveAndFlush(employeeEntity))
                .thenReturn(employeeEntity);
        when(employeeMapper.toDto(employeeEntity))
    ...
    void updateNonExistingEmployee() {
        ...
        HrmException exception = assertThrows(HrmException.class, () -> employeeService.update(EMPLOYEE_ID, employeeUpdate));
    ...
    void deleteNonExistingEmployee() {
        ...
        HrmException exception = assertThrows(HrmException.class, () -> employeeService.delete(EMPLOYEE_ID));
